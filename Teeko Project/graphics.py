...
class graphics_handler:
  ...
  def __init__(self, window, screen_surface):
    ...
    self.board_image = pg.image.load('board.png').convert()
    self.red_cir_image = pg.image.load('redCircle.png').convert_alpha()
    self.black_cir_image = pg.image.load('blackCircle.png').convert_alpha()
    self.start_bg = pg.image.load("start_bg.png").convert()
    self.start_button = pg.image.load("start_button.png").convert_alpha()
    self.instructions = pg.image.load("instructions.png").convert()
    self.highlight_button = pg.image.load("highlight.png").convert_alpha()
    self.black_turn = pg.image.load("black_turn.png").convert_alpha()
    self.red_turn = pg.image.load("red_turn.png").convert_alpha()
